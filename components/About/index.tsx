...
const About = () => {
  return (
    <>
      {/* <!-- ===== About Start ===== --> */}
      <section className="overflow-hidden pb-20 md:mt-10 lg:pb-25 xl:pb-30">
          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero">
                ...
                <span className="relative inline-block before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full before:bg-titlebg dark:before:bg-green-600">
                  AI Bots
                </span>
              </h2>
              <p>
        ...
        <div className="mx-auto max-w-c-1235 overflow-hidden px-4 md:px-8 2xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero">
                Beautiful & Engaging {"   "}
                <span className="relative inline-block before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full before:bg-amber-300 dark:before:bg-orange-500">
                  Flashcards
                </span>
              </h2>
              <p>
              ...
              <div className="mt-7.5 flex items-center gap-5"></div>
              <div className="mt-7.5 flex items-center gap-5">
                <div className="flex h-15 w-15 items-center justify-center rounded-[50%] border border-stroke dark:border-strokedark dark:bg-blacksection">
                  <p className="text-metatitle2 font-semibold text-black dark:text-white">
                    02
                ...
                <div className="w-3/4">
                  <p>
                    Flashcard-based learning is effective because it leverages
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero">
                Download & Learn Even{" "}
                <span className="relative inline-block before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full before:bg-pink-300 dark:before:bg-pink-600">
                  Offline
                </span>
              </h2>
              <p>
